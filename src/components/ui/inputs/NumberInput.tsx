...
const NumberInput = ({ value, onChange, min = 0, max = 100 }: NumberInputProps) => (
  <div>
    ...
    <input
      ...
      value={value}
      onChange={onChange}
      className="mt-1 block w-full rounded-md border border-gray-300 dark:border-gray-700 p-1.5 text-gray-700 dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
      min={min}
      max={max}
      placeholder=""
    />
