...
const SocialLoginButtons = () => {
  return (
    <div className="flex w-full flex-wrap justify-center gap-2 sm:flex-nowrap">
      <button className="flex flex-1 items-center justify-center rounded-md text-gray-800 bg-gray-200 border border-gray-300 px-3 py-2 text-sm transition hover:bg-gray-300">
